...
references:
  - kind: lines
    path: /lib/memory/rfc/draft/<refactor-rfc>.md
    range: [<start>, <end>]
    contentHash: <sha256>
    note: "Refactor RFC."
  - kind: lines
...
# severity: block
# references:
#   - "/lib/memory/handbook/contract-templates/behavior-preservation.template.md"
# custom:
#   pancreator.contract_id: <feature>.behavior-preservation
#   pancreator.applies_to: pipeline-telemetry:debt-grooming#aggregated-behavior-preservation
package pancreator.refactor.behavior_preservation
...
`/lib/memory/handbook/contract-style.md` Rule 4.3).
