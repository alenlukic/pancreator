...
related:
  ...
  - /archive/work/173010_04-26-26/23777_1723_templates/policy-compliance.example.json
---
...
- `/work/<day>/<task-id>/policy-compliance.json`
...
- `governing_sources_checked` MUST include all three required sources exactly as
  canonical paths: `AGENTS.md`, `lib/memory/handbook/constitution.md`, and
  `docs/PRD.md`.
- `documentation_impact` MUST follow the decision spirit and required fields
  from `/lib/memory/handbook/documentation-impact-contract.md`.
