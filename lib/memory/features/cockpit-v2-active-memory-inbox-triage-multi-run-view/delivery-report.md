...
{
  "kind": "lines",
  "path": "client/src/components/cockpit/pipeline/MultiRunTable.tsx",
  "range": [19, 29],
  "contentHash": "4f4782f"
}
```
...
- Sixteen staged files sit outside the declared 21-path touch-set because sibling Cockpit v2 infrastructure (config route, stage grid, shared states) ships bundled with `PipelineModule` integration; review recommends widening the touch-set or splitting delivery commits.
