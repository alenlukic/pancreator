...
## Touch Set
- `lib/internal/packages/@pancreator/policy/**`
- `lib/memory/features/pancreator-policy/contracts/**`
- `lib/memory/features/pancreator-policy/spec.md`
- `lib/memory/features/pancreator-policy/plan.md`
- `lib/memory/features/pancreator-policy/tasks.md`
