...
- [x] T2: README Quickstart + migration contract section (`pancreator.policy.readme_ergonomics`).
...
- [ ] T5 (deferred): Rego/Conftest evaluation, Cedar `Authorizer` adapter, and CLI `pan upgrade --apply` persistence (Phase 4 / M2 per plan).
