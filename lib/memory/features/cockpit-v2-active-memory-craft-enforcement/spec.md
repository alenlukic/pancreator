---
title: Cockpit v2 active memory craft enforcement Engineering Spec
...
source_inbox_item: lib/inbox/in/172966_06-09-26/82800_0059_cockpit-v2-active-memory-craft-enforcement.md
depends_on:
...
intake_notes:
  ...
  - Design audit run 82901_0058 records five remaining P1 gate failures F-01, F-02, F-09, F-11, and F-12 on the Active memory panel after the cockpit-v2-active-memory-operator-readability implement pass remediated F-05 and F-10.
...
references:
  - kind: lines
    path: lib/inbox/in/172966_06-09-26/82800_0059_cockpit-v2-active-memory-craft-enforcement.md
    range: [46, 64]
  ...
  - kind: lines
    path: lib/memory/features/cockpit-v2-active-memory-operator-readability/delivery-report.md
    range: [1, 40]
...
on the Cockpit v2 Active memory panel per design audit run 82901_0058 findings
...
- When `.active-memory-header` is inspected, `accentButtonCount` (elements with
  `cockpit-action-button` accent fill) SHALL equal exactly 1.
