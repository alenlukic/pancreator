---
title: Cockpit v2 active memory craft enforcement UX Spec
feature_id: cockpit-v2-active-memory-craft-enforcement
task_id: 82780_0100_cockpit-v2-active-memory-craft-enforcement
program: cockpit-v2
stage: plan
...
references:
  - kind: lines
    path: lib/memory/features/cockpit-v2-active-memory-craft-enforcement/spec.md
    range: [103, 196]
    note: Engineering spec acceptance criteria for gates #2, #3, #9, #11, #12 and F-05/F-10 retention.
  - kind: lines
    path: .pan/work/172966_06-09-26/82901_0058_cockpit-design-audit-delivery/cockpit-design-audit.md
    range: [63, 136]
...
# Cockpit v2 active memory craft enforcement UX Spec
...
```
┌─ Active memory ─────────────────────────────┐
│ Cockpit v2 active memory craft enforcement  │
│ cockpit-v2-active-memory-craft…      [⎘]    │
...
Scoped to `.active-memory-header` only; reuse Cockpit v2 tokens from `globals.css`.
...
| `.active-memory-refresh-link` | accent `.cockpit-action-button` | Sole accent control |
...
- **Accent** — exactly one accent `.cockpit-action-button` (refresh CTA); copy icon is ghost.
...
```yaml
contract:
  id: cockpit-v2-active-memory-craft-enforcement.ux.no-visible-path-default-view
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
    path: /lib/memory/features/cockpit-v2-active-memory-craft-enforcement/ux-spec.md
  ...
  metadata:
    pancreator.contract_id: cockpit-v2-active-memory-craft-enforcement.ux.no-visible-path-default-view
    pancreator.applies_to: artifact-symbol:/lib/memory/features/cockpit-v2-active-memory-craft-enforcement/ux-spec.md#Active-memory-header
    pancreator.wcag-criteria: ["2.4.6"]
```

```yaml
contract:
  id: cockpit-v2-active-memory-craft-enforcement.ux.refresh-cta-open-operation-md
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  runtime:
    ...
    panel: { quorum: 2-of-3, judges: [haiku, haiku, sonnet], seed: 42, cost_ceiling_usd: 0.50 }
  metadata:
    pancreator.contract_id: cockpit-v2-active-memory-craft-enforcement.ux.refresh-cta-open-operation-md
    pancreator.applies_to: artifact-symbol:/lib/memory/features/cockpit-v2-active-memory-craft-enforcement/ux-spec.md#Active-memory-header
...
```yaml
contract:
  id: cockpit-v2-active-memory-craft-enforcement.ux.solid-elevated-panel-chrome
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  runtime:
    ...
    panel: { quorum: 2-of-3, judges: [haiku, haiku, sonnet], seed: 42, cost_ceiling_usd: 0.50 }
  metadata:
    pancreator.contract_id: cockpit-v2-active-memory-craft-enforcement.ux.solid-elevated-panel-chrome
    pancreator.applies_to: artifact-symbol:/lib/memory/features/cockpit-v2-active-memory-craft-enforcement/ux-spec.md#Visual-design-tokens
    pancreator.wcag-criteria: []
```

```yaml
contract:
  id: cockpit-v2-active-memory-craft-enforcement.ux.blockers-chip-summarization
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  runtime:
    ...
    panel: { quorum: 2-of-3, judges: [haiku, haiku, sonnet], seed: 42, cost_ceiling_usd: 0.50 }
  metadata:
    pancreator.contract_id: cockpit-v2-active-memory-craft-enforcement.ux.blockers-chip-summarization
    pancreator.applies_to: artifact-symbol:/lib/memory/features/cockpit-v2-active-memory-craft-enforcement/ux-spec.md#Active-memory-header
    pancreator.wcag-criteria: ["2.4.6"]
```
...
```yaml
contract:
  id: cockpit-v2-active-memory-craft-enforcement.ux.single-accent-cta
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  description: |
    ...
    with cockpit-action-button accent fill SHALL equal exactly 1 and the
  ...
  runtime:
    rubric:
      ...
      examples:
        ...
        bad:
          - text: "Two accent-filled cockpit-action-button elements."
            rationale: Accent sprawl fail.
    panel: { quorum: 2-of-3, judges: [haiku, haiku, sonnet], seed: 42, cost_ceiling_usd: 0.50 }
  metadata:
    pancreator.contract_id: cockpit-v2-active-memory-craft-enforcement.ux.single-accent-cta
    pancreator.applies_to: artifact-symbol:/lib/memory/features/cockpit-v2-active-memory-craft-enforcement/ux-spec.md#Active-memory-header
    pancreator.wcag-criteria: []
```
