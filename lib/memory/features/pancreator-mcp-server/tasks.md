...
- [x] T1: Confirm package scaffold and exported surface satisfy `pancreator.mcp_server.package_shape` (done in Phase 3 step 9; `package.json`, `README.md`, `lib/index.ts` are present; Rego revalidation remains with the contract runner in Phase 2+ gates).
