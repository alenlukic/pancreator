---
title: Command Center active memory, inbox triage, and multi-run view Engineering Spec
...
source_inbox_item: lib/inbox/in/172967_06-08-26/54352_0854_command-center-pipeline-orientation.md
depends_on: [command-center-live-run-refresh-and-stage-artifact-drawer]
blocks: [command-center-maintenance-toolkit]
...
intake_notes:
  ...
  - The directive dependency shorthand command-center-pipeline-live-artifacts maps to the canonical Feature id command-center-live-run-refresh-and-stage-artifact-drawer.
...
references:
  - kind: lines
    ...
    range: [24, 27]
    note: Source directive Problem section states operators leave the Command Center for current.md, inbox paths, and multi-run monitoring.
  - kind: lines
    path: lib/inbox/in/172967_06-08-26/54352_0854_command-center-pipeline-orientation.md
    range: [28, 37]
  ...
  - kind: lines
    path: lib/memory/features/command-center-ux-spec-and-information-architecture/ux-spec.md
    range: [168, 183]
    note: Ratified component inventory under client/src/components/command-center/pipeline/.
  - kind: lines
  ...
  - kind: lines
    ...
    range: [90, 101]
    note: Shipped command-center Feature establishes DashboardModuleShell, Pipeline module, and run-state field split.
  - kind: lines
...
This Feature SHALL deliver Command Center orientation surfaces so operators monitor
...
- Automations and Maintenance module implementation beyond placeholders already
  shipped by prior Command Center Features.
- Inbox archival, `pan intake` from the Command Center, or writes to `lib/inbox/out/`.
...
- Pre-close validation button placement; the `command-center-maintenance-toolkit`
