...
source_inbox_item: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md
...
references:
  - kind: lines
    path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md
    range: [19, 23]
    contentHash: 970e45f
...
`{kind: lines, path: lib/memory/features/us-1-dogfood-phase-4-exit/spec.md, range: [208, 232], contentHash: 8796dd7}`.
...
`{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [25, 29], contentHash: 970e45f}`.
...
`{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [39, 43], contentHash: 970e45f}`.
...
- When the operator invokes `pan pause 71096_0415_phase-4-intervention-probe-pause-resume-abort`
  ...
  `{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [47, 47], contentHash: 970e45f}`.
...
- When the operator invokes `pan resume 71096_0415_phase-4-intervention-probe-pause-resume-abort`
  ...
  `{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [48, 48], contentHash: 970e45f}`.
...
- When the operator invokes `pan abort 71096_0415_phase-4-intervention-probe-pause-resume-abort --reason <text>`
  ...
  directive at
  `{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [49, 49], contentHash: 970e45f}`.
...
- When every intervention record is complete, the evidence file paths MUST be
  ...
  `{kind: lines, path: lib/memory/features/us-1-dogfood-phase-4-exit/phase-4-proof-bundle.md, range: [27, 35], contentHash: 1801f6f}`.
...
- When the operator populates `pause-resume-abort-evidence.json`, each
  ...
  `archive/work/172988_05-18-26/71096_0415_phase-4-intervention-probe-pause-resume-abort/run.log.jsonl`
  per the parent spec acceptance group at
  `{kind: lines, path: lib/memory/features/us-1-dogfood-phase-4-exit/spec.md, range: [228, 232], contentHash: 8796dd7}`.

## Out of scope

- This Feature SHALL NOT substitute for the end-to-end nested proof-bundle-index
  run, per the source directive non-goal at
  `{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [33, 33], contentHash: 970e45f}`.
...
- Phase 5 M1 backlog delivery SHALL NOT start during or after this Feature's
  ...
  `{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [35, 35], contentHash: 970e45f}`.
...
- Empirical CLI execution for pause, resume, and abort transitions belongs to the
  ...
  non-goal at
  `{kind: lines, path: archive/inbox/in/172990_05-16-26/86400_0000_phase-4-intervention-probe.md, range: [37, 37], contentHash: 970e45f}`.
