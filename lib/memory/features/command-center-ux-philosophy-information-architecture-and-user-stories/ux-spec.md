---
title: Command Center UX philosophy, information architecture, and user stories UX Spec
feature_id: command-center-ux-philosophy-information-architecture-and-user-stories
task_id: 69695_0438_command-center-ux-philosophy-information-architecture-and-user-stories
...
7. **Local-native, repo-aware** — browse, open, edit, and trigger runs from repo objects; Command Center is the operational layer over the repo substrate.
...
```yaml
contract:
  id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.command-center-operational-state
  kind: llm-judge
  severity: block
  applies_to:
  ...
  metadata:
    pancreator.contract_id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.command-center-operational-state
    pancreator.applies_to: artifact-symbol:/lib/memory/features/command-center-ux-philosophy-information-architecture-and-user-stories/ux-spec.md#Command-Center-41
```

```yaml
contract:
  id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.fd-mission-control-stage-rail
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  runtime:
    ...
    panel:
      ...
      cost_ceiling_usd: 0.50
  metadata:
    pancreator.contract_id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.fd-mission-control-stage-rail
    pancreator.applies_to: artifact-symbol:/lib/memory/features/command-center-ux-philosophy-information-architecture-and-user-stories/ux-spec.md#FD-Mission-Control-44
```

```yaml
contract:
  id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.kickoff-flow-inputs
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  runtime:
    ...
    panel:
      ...
      cost_ceiling_usd: 0.50
  metadata:
    pancreator.contract_id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.kickoff-flow-inputs
    pancreator.applies_to: artifact-symbol:/lib/memory/features/command-center-ux-philosophy-information-architecture-and-user-stories/ux-spec.md#Work-Intake--Kickoff-43
```

```yaml
contract:
  id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.compliance-remediation-actions
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  runtime:
    ...
    panel:
      ...
      cost_ceiling_usd: 0.50
  metadata:
    pancreator.contract_id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.compliance-remediation-actions
    pancreator.applies_to: artifact-symbol:/lib/memory/features/command-center-ux-philosophy-information-architecture-and-user-stories/ux-spec.md#Compliance--Recovery-45
```

```yaml
contract:
  id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.theme-token-application
  kind: llm-judge
  severity: block
  applies_to:
    kind: artifact-symbol
  ...
  owner: design-engineer
  description: |
    When any first-slice Command Center surface renders, the shell SHALL apply CSS
  ...
  runtime:
    ...
    panel:
      ...
      cost_ceiling_usd: 0.50
  metadata:
    pancreator.contract_id: command-center-ux-philosophy-information-architecture-and-user-stories.ux.theme-token-application
    pancreator.applies_to: artifact-symbol:/lib/memory/features/command-center-ux-philosophy-information-architecture-and-user-stories/ux-spec.md#Visual-design-tokens
