...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/31248_1519_command-center-local-scheduler-tick-and-run-history/review.md",
  "range": [5, 5],
  "contentHash": "6208bd7"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/31248_1519_command-center-local-scheduler-tick-and-run-history/test-report.md",
  "range": [5, 5],
  "contentHash": "dc3dfbd"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/31248_1519_command-center-local-scheduler-tick-and-run-history/adr-draft.md",
  "range": [58, 61],
  "contentHash": "04c00ca"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/31248_1519_command-center-local-scheduler-tick-and-run-history/plan.md",
  "range": [21, 37],
  "contentHash": "11a8613"
}
```
...
- Command Center UI surfaces include `AutomationListView` with enabled Run now, `AutomationRunHistory` with expandable stdout/stderr excerpts, and `AutomationsModule` wiring selection, history refresh, and list-row status badges.
...
- To trigger Run now from Command Center, POST to `/api/automations/<id>/run`; the route test creates an agent automation, dispatches a manual run, and asserts HTTP 200 with the automation id in outcomes.
...
- To inspect run history in Command Center, select an automation row and expand stdout excerpts; the page test asserts enabled Run now, no-selection empty state, row selection loading run rows, and no-runs empty state for a selected automation without history.
