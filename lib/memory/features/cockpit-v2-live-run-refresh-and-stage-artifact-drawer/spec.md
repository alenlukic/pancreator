---
title: Cockpit v2 live run refresh and stage artifact drawer Engineering Spec
...
source_inbox_item: lib/inbox/in/172967_06-08-26/54352_0854_cockpit-v2-pipeline-live-artifacts.md
depends_on: [cockpit-v2-pipeline-command-center-and-human-gate-queue]
blocks: [cockpit-v2-pipeline-orientation]
...
references:
  - kind: lines
    path: lib/inbox/in/172967_06-08-26/54352_0854_cockpit-v2-pipeline-live-artifacts.md
    range: [24, 27]
  ...
  - kind: lines
    ...
    range: [90, 101]
    note: Shipped command-center Feature establishes CockpitShell, Pipeline module extraction, and run-state field split this Feature extends.
  - kind: lines
...
artifact drawer to the Cockpit v2 Pipeline module so operators observe SDK runs
...
- When a stage cell status is `active`, the cell SHALL render a visible pulse
  treatment on the status badge per cockpit-v2 stage-active tokens.
