...
- To start the proof-bundle path, use `lib/inbox/in/phase-4-dogfood-proof-bundle-index.md`, run the nested delivery flow, and preserve the resulting `run.log.jsonl` before you fill the proof tables. 
