...
1. Nested proof-bundle-index task ledger and preserved `run.log.jsonl` (canonical
   ...
   `archive/work/<day>/<nested-task-id>/`; the **librarian** SHALL
...
3. `pause-resume-abort-evidence.json` — this file is **not** produced by the
   ...
   `archive/inbox/in/172988_05-18-26/71040_0416_intake-phase-4-intervention-probe-pause-resume-abort-ratification.md`.
