...
{
  "kind": "lines",
  "path": ".pan/work/172966_06-09-26/50770_0953_command-center-feature-delivery-mission-control-run-detail/review.md",
  "range": [3, 5],
  "contentHash": "0075d23"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172966_06-09-26/50770_0953_command-center-feature-delivery-mission-control-run-detail/test-report.md",
  "range": [3, 5],
  "contentHash": "eb318d1"
}
```
...
- FD Mission Control SHALL compose a single-run inspection surface at route `/mission-control` inside the Command Center shell, fetch task envelopes from `GET /api/run-state`, poll every 7500 ms for non-terminal runs, and render header, banner, rail, detail panel, artifacts accordion, and verbose log drawer in vertical stack order.

```json
{
  "kind": "lines",
  "path": ".pan/work/172966_06-09-26/50770_0953_command-center-feature-delivery-mission-control-run-detail/plan.md",
  "range": [3, 5],
  "contentHash": "3fe53ec"
}
```

- `StageMachineGrid` and `RunEventTimeline` SHALL live under `client/src/components/command-center/mission-control/` as canonical implementations; the Pipeline module SHALL consume thin re-exports so P9 regression behavior stays unchanged.
...
{
  "kind": "lines",
  "path": ".pan/work/172966_06-09-26/50770_0953_command-center-feature-delivery-mission-control-run-detail/adr-draft.md",
  "range": [43, 45],
  "contentHash": "cb56fb7"
}
```
...
- Mission Control SHALL consume read-only `GET /api/run-state` envelopes and existing `run-state-shared.ts` helpers; remediation CTAs SHALL stub with operator-visible toasts until `command-center-quick-fix` lands.
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/MissionControlModule.tsx",
  "range": [27, 29],
  "contentHash": "b718701"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/RunContextHeader.tsx",
  "range": [32, 44],
  "contentHash": "8499080"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/MissionControlStageRail.tsx",
  "range": [5, 17],
  "contentHash": "b4ced7d"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/StageMachineGrid.tsx",
  "range": [16, 16],
  "contentHash": "25e3b7e"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/StageDetailPanel.tsx",
  "range": [45, 63],
  "contentHash": "b33b54b"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/ArtifactsByStage.tsx",
  "range": [25, 38],
  "contentHash": "698c004"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/RetryLimitBanner.tsx",
  "range": [4, 12],
  "contentHash": "9a342b1"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/remediation.ts",
  "range": [1, 10],
  "contentHash": "ddc31a8"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/VerboseLogDrawer.tsx",
  "range": [7, 7],
  "contentHash": "39f7bd1"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/dashboard-file-modal.tsx",
  "range": [215, 215],
  "contentHash": "07c421d"
}
```
...
- Remediation CTAs remain stub toasts until `command-center-quick-fix` lands; operators see action names but no mutating run-control handlers yet.
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/mission-control/mission-control.test.tsx",
  "range": [167, 183],
  "contentHash": "23af121"
}
```
...
Coverage delta against the prior Command Center baseline adds 20 focused mission-control tests in `mission-control.test.tsx` and restores the full client suite to 163 passing tests after the operator-readability re-entry. All four touch-set gate commands exit zero: client lint, typecheck, focused mission-control suite (20/20), and full client suite (163/163). New-line statement coverage on changed production paths is 100 percent and branch coverage on new conditionals meets the 70 percent medium-tier `new_lines_only` threshold. Chrome DevTools re-inspection records `design_qa_passes: true` for Tier-1 mission-control surfaces. Full-repository `pnpm run build` and `node --test` failures remain pre-existing issues excluded from the gate.
