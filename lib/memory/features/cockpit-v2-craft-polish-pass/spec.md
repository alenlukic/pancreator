---
title: Cockpit v2 — craft polish pass Engineering Spec
feature_id: cockpit-v2-craft-polish-pass
task_id: 8919_2131_cockpit-v2-craft-polish-pass
program: cockpit-v2
stage: intake
...
source_inbox_item: lib/inbox/in/172967_06-08-26/8947_2130_cockpit-v2-craft-polish-pass.md
depends_on:
  - cockpit-v2-ux-spec-and-information-architecture
  - cockpit-v2-pipeline-command-center-and-human-gate-queue
  - cockpit-v2-active-memory-inbox-triage-multi-run-view
  - cockpit-v2-automation-registry-and-management-ui
  - cockpit-v2-maintenance-toolkit-compliance-tests
...
intake_notes:
  ...
  - The directive source_channel cockpit-design-audit-delivery maps to design audit run 9186_2126 with blocker B1 and majors M1–M6 as the bounded fix scope.
...
references:
  - kind: lines
    path: lib/inbox/in/172967_06-08-26/8947_2130_cockpit-v2-craft-polish-pass.md
    range: [28, 37]
  ...
  - kind: lines
    path: lib/inbox/in/172967_06-08-26/8947_2130_cockpit-v2-craft-polish-pass.md
    range: [84, 87]
    note: Source directive Touch set lists cockpit components and globals.css focus tokens.
  - kind: lines
    path: .pan/work/158_06-08-26/9186_2126_cockpit-design-audit-delivery/cockpit-design-audit.md
    range: [39, 54]
...
This Feature SHALL deliver one bounded Cockpit v2 craft-polish pass that closes
design-audit blocker B1 and majors M1–M6 without redesigning the palette or
changing API routes. The live cockpit exposes module tabs without WAI-ARIA tablist
...
- When an operator focuses the module tab strip, the DOM SHALL expose a single
  `role="tablist"` on `.cockpit-module-tabs` and `role="tab"` on each module
...
- Full cockpit redesign or palette and token overhaul per source directive.
