...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/8919_2131_cockpit-v2-craft-polish-pass/review.md",
  "range": [3, 5],
  "contentHash": "9df484b"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/8919_2131_cockpit-v2-craft-polish-pass/test-report.md",
  "range": [3, 5],
  "contentHash": "8f04dbb"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/8919_2131_cockpit-v2-craft-polish-pass/adr-draft.md",
  "range": [46, 54],
  "contentHash": "2ce67b3"
}
```
...
- `CockpitShell` exposes WAI-ARIA tablist semantics, roving `tabIndex`, keyboard activation, and tabpanel wiring for Pipeline, Automations, Maintenance, and Files.
...
{
  "kind": "lines",
  "path": "client/src/components/cockpit/pipeline/PipelineEmptyRunState.tsx",
  "range": [12, 25],
  "contentHash": "5d42e35"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/cockpit/maintenance/ComplianceAuditPanel.tsx",
  "range": [32, 42],
  "contentHash": "e883150"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/cockpit/automations/AutomationWizard/Shell.tsx",
  "range": [25, 35],
  "contentHash": "2548395"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/cockpit/shared/useFocusTrap.ts",
  "range": [8, 20],
  "contentHash": "41d26f2"
}
```
