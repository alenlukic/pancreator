...
initial_approval_artifact: lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-03-approval.md
rejection_artifact: lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-04-human-reject.md
...
references:
  ...
  - kind: lines
    path: lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-02.md
    range: [1, 17]
    contentHash: 79664d8
    note: Interim canonical fallback that resolves blocked gate identifiers.
  - kind: lines
    path: lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-03-approval.md
    range: [1, 8]
    contentHash: bff1c88
    note: Initial human approval artifact that authorizes intake exit to plan.
  - kind: lines
    path: lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-04-human-reject.md
    range: [1, 17]
    contentHash: 0baa4c8
    note: Human rejection artifact that reopens remediation and constrains plan-level corrections.
  - kind: lines
    path: lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-05-human-approve.md
    range: [1, 3]
    contentHash: 0cabf59
    note: Human approval artifact that closes intake remediation and reaffirms plan handoff.
  - kind: lines
    path: lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-06-human-approve.md
    range: [1, 3]
    contentHash: 0cabf59
