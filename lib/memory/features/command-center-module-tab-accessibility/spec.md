---
title: Command Center module tab accessibility Engineering Spec
feature_id: command-center-module-tab-accessibility
task_id: 4426_2246_command-center-module-tab-accessibility
...
source_inbox_item: lib/inbox/in/172967_06-08-26/9443_2122_command-center-tab-a11y.md
depends_on:
  - command-center-ux-spec-and-information-architecture
blocks:
  - command-center-craft-polish-pass
...
references:
  - kind: lines
    path: lib/inbox/in/172967_06-08-26/9443_2122_command-center-tab-a11y.md
    range: [21, 27]
    note: Source directive Problem section states F-01 blocker and missing WAI-ARIA tabs pattern in DashboardModuleShell.
  - kind: lines
    path: lib/inbox/in/172967_06-08-26/9443_2122_command-center-tab-a11y.md
    range: [25, 27]
  ...
  - kind: lines
    path: .pan/work/172967_06-08-26/9781_2116_command-center-design-audit-delivery/command-center-design-audit.md
    range: [46, 54]
    note: Design audit F-01 observation and recommended DashboardModuleShell tab-pattern fix.
  - kind: lines
    path: .pan/work/172967_06-08-26/9781_2116_command-center-design-audit-delivery/command-center-design-audit.md
    range: [126, 134]
...
Automations, Maintenance, and Files module navigation in Command Center so screen
...
9781_2116 failed with blocker F-01 because `DashboardModuleShell` exposed module
...
- When the Command Center renders module tabs, the selected tab SHALL carry
...
- When an operator presses Enter or Space on a focused module tab, the Command Center
...
- When `client/src/app/page.test.tsx` runs module tab tests, the suite SHALL
  ...
  behavior, and Enter or Space activation without regressing unrelated Command Center
  modules.
- When implementers modify the repository for this Feature, changes SHALL
  remain within `client/` paths for Command Center shell layout, related styles, and
...
- Pipeline empty-run panel placeholders per source directive (audit F-02,
  feature `command-center-pipeline-empty-states`).
...
- Full Command Center redesign, palette changes, or non-tab accessibility work outside
