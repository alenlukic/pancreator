...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/4426_2246_command-center-module-tab-accessibility/review.md",
  "range": [3, 5],
  "contentHash": "80925e7"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/4426_2246_command-center-module-tab-accessibility/test-report.md",
  "range": [3, 5],
  "contentHash": "57171c7"
}
```
...
- Command Center module navigation SHALL adopt the WAI-ARIA tabs pattern with roving `tabIndex`, `aria-controls` / `tabpanel` pairing, and manual activation so arrow keys move focus only and Enter or Space switch modules through existing `onActiveModuleChange`.

```json
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/4426_2246_command-center-module-tab-accessibility/plan.md",
  "range": [5, 15],
  "contentHash": "3a05475"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/4426_2246_command-center-module-tab-accessibility/adr-draft.md",
  "range": [43, 48],
  "contentHash": "e453189"
}
```
...
- `DashboardModule` is the union type for Pipeline, Automations, Maintenance, and Files module identifiers.
...
- `DashboardModuleShell` exposes WAI-ARIA `tablist` semantics, roving `tabIndex`, manual keyboard activation, and `tabpanel` wiring for all four modules.
...
- `.dashboard-module-tab:focus-visible` and `.dashboard-module-tab-active:focus-visible` define the accent outline and active-tab halo for keyboard focus visibility.
