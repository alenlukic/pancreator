---
id: surface-opt-p9-dashboard-operator-cockpit
title: "surface-opt P9 — dashboard operator cockpit"
status: draft
stage: intake
...
piece: P9
depends_on: ["P5", "P6"]
source_directive: lib/inbox/in/172974_06-01-26/75420_0303_surface-opt-p9-dashboard-cockpit.md
references:
  - kind: lines
    path: lib/inbox/in/172974_06-01-26/75420_0303_surface-opt-p9-dashboard-cockpit.md
    range: [31, 100]
    contentHash: 33af51c
    note: "Source directive: problem statement, goal, touch set, R1–R4, AC1–AC5, out-of-scope, dependencies, and implementation notes for the P9 dashboard operator cockpit."
  - kind: lines
...
# Engineering Spec — surface-opt P9 dashboard operator cockpit
...
SHALL carry `data-testid="tab-cockpit"` and SHALL be selected by default. The
...
`GET /api/activity` route on the default cockpit view. `DashboardPage` SHALL
...
| Date | Author | Change |
|------|--------|--------|
| 2026-06-02 | intake-analyst | Initial canonical Engineering Spec from source directive `75420_0303_surface-opt-p9-dashboard-cockpit.md`. |
