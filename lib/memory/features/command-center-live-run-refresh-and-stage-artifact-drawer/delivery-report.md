...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/51057_0949_command-center-live-run-refresh-and-stage-artifact-drawer/review.md",
  "range": [3, 6],
  "contentHash": "1000a8d"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/51057_0949_command-center-live-run-refresh-and-stage-artifact-drawer/test-report.md",
  "range": [3, 5],
  "contentHash": "3250220"
}
```
...
- Command Center Pipeline SHALL poll `GET /api/run-state` on a 5-second to 10-second interval while any non-terminal task has an active stage cell, SHALL merge envelopes into React state without remounting `DashboardPage`, and SHALL stop polling when every task is terminal.

```json
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/51057_0949_command-center-live-run-refresh-and-stage-artifact-drawer/plan.md",
  "range": [5, 10],
  "contentHash": "f6b7f3d"
}
```
...
{
  "kind": "lines",
  "path": ".pan/work/172967_06-08-26/51057_0949_command-center-live-run-refresh-and-stage-artifact-drawer/adr-draft.md",
  "range": [44, 50],
  "contentHash": "2de14bd"
}
```
...
{
  "kind": "lines",
  "path": "client/src/components/command-center/pipeline/ArtifactDrawer.tsx",
  "range": [1, 30],
  "contentHash": "5e5aaac"
}
```
