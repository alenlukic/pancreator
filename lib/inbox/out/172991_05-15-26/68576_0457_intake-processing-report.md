...
- `lib/inbox/in/compliance-tests.md` -> processed in intake round 1.
- `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-01.md` -> processed as operator
  clarification input in intake round 2.
- `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-02.md` -> resolved with interim
  canonical fallback for gate blocking.
- `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-03-approval.md` -> ratified intake
  exit and authorized handoff to `plan`.
- `lib/inbox/in/compliance-tests.md` -> archived to
  `archive/inbox/in/172991_05-15-26/68576_0457_compliance-tests.md` after intake closeout.

## Spec artifacts created or updated

- `lib/memory/features/compliance-tests/index.json` (feature status and handoff metadata).
- `lib/memory/features/compliance-tests/spec.md` (canonicalized engineering spec,
  status: `intake-approved-for-plan`; round-03 approval folded).
- `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-01.md` (clarifying questions for
  human response).
- `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-02.md` (resolved clarification and
  interim canonical fallback decision).
- `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-03-approval.md` (human approval for
  intake exit to `plan`).
...
- Approval artifact is `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-03-approval.md`.
...
documentation_impact:
  ...
  changed-surfaces:
    ...
    - lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-01.md
    - lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-02.md
    - lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-03-approval.md
    - lib/inbox/out/172991_05-15-26/68576_0457_intake-processing-report.md
  deferred-items: []
```

## Post-approval rejection processing (round 04)

- `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-04-human-reject.md` -> processed as a
...
- Plan directives MUST target compliance schemas and test descriptors under
  `lib/internal/tests/compliance/` and `lib/internal/tests/compliance/schemas/`, not
  `lib/memory/features/compliance-tests/contracts/tests/`.
...
- Invocation policies MUST cover structure-change scenarios previously
  clarified in `lib/inbox/threads/172991_05-15-26/compliance-tests/68576_0457_round-01.md`.
...
- Required outputs for remediation handoff:
  1. Replace incorrect path instructions in `archive/work/173009_04-27-26/68576_0457_compliance-tests/plan.md`
     with canonical `lib/internal/tests/compliance/` targets.
  ...
  4. Reissue `archive/work/173009_04-27-26/68576_0457_compliance-tests/touch-set.json` so the coder scope includes
