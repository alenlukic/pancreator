...
spec_path: lib/memory/features/inbox-directory-hierarchy-migration/spec.md
status: ratified
references:
  - kind: lines
  ...
  - kind: lines
    path: lib/memory/features/inbox-directory-hierarchy-migration/spec.md
    range: [1, 304]
...
`lib/memory/features/inbox-directory-hierarchy-migration/spec.md`.
...
are folded into
`lib/memory/features/inbox-directory-hierarchy-migration/spec.md` under
