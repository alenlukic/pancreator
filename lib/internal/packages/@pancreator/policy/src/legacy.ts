...
const DEPRECATION_LINE =
  "[@pancreator/policy] DEPRECATED: loadLegacyPolicyConfig() reads legacy JSON/YAML threshold-policy files. Migrate with upgradePolicyConfig() and persist via `pan upgrade --apply` (docs/BOOTSTRAP.md Phase 3 step 8 policy migration; internal tracker Q23).\n";
