...
const TIER_META = /** @type {const} */ ({
  ...
  durable_memory: {
    ...
    dir: "`lib/memory/features/**`, `lib/memory/adr/**`, `lib/memory/backlog/**`",
  },
  archival_memory: {
    label: "4 archival memory",
    dir: "`archive/work/**`, `lib/inbox/out/**`, `archive/inbox/**`, `lib/inbox/threads/**`",
  },
  internal_operating: {
  ...
  source_code: { label: "7 source code & tests", dir: "`lib/internal/packages/**`, `lib/internal/tools/**`, `tests/**`" },
  generated_machine: {
...
function printReport() {
  ...
  const legacyScopes = [
    ...
    { id: "archived_work", label: "Archived work slice: archive/work/**", pred: (rel) => /^archive\/work(?:\/|$)/.test(posixRel(rel)) },
