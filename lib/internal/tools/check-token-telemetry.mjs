 ...
 *   node lib/internal/tools/check-token-telemetry.mjs --floor 0.08
 *   node lib/internal/tools/check-token-telemetry.mjs --strict --target 0.8
 *   node lib/internal/tools/check-token-telemetry.mjs --window 14d --json
 */
