 ...
 *
 * Usage:
 *   node lib/internal/tools/refresh-tbd-contenthash.mjs [--dry-run|--write]
 *
...
const EXCLUDED_FILES = new Set([
  ...
  "lib/internal/tools/reformat-markdown-citations.mjs",
  "lib/internal/tools/migrate-timestamp-naming.mjs",
  "lib/internal/tools/refresh-tbd-contenthash.mjs",
]);
