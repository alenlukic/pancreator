...
`{kind: lines, path: lib/memory/adr/0004-documentation-impact-contract.md, range: [51, 75], contentHash: TBD-on-commit}`
...
1. The implement stage SHALL update only
   `lib/memory/features/us-1-dogfood-phase-4-exit/phase-4-proof-bundle.md`
