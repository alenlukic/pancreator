...
1. **Navigation** — `GET /api/list` returns typed `file | directory` entries, filters `lib/inbox/notes/**`, and the dashboard drills into directories via breadcrumbs while opening files only for leaf entries.
...
- `archive/work/172978_05-28-26/24456_1712_feature-delivery-harness-wire-cursorrunner-through-run-and-advance/policy-compliance.json`
- `lib/memory/features/feature-delivery-harness-wire-cursorrunner-through-run-and-advance/index.json`
