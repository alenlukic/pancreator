...
| `node lib/internal/tools/run-compliance.mjs` | 0 | pass | shell transcript |
| `node lib/internal/tools/check-phase-0a-scaffold.mjs` | 0 | pass | shell transcript |
| `node lib/internal/tools/check-operator-output.mjs` | 0 | pass | shell transcript |
...
- Directory drill-down via typed list entries; `lib/inbox/notes/**` filtered server-side.
