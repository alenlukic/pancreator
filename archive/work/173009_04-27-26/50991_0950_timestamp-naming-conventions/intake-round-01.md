...
- Stage: `intake`
- Directive: `lib/inbox/in/timestamp_naming_conventions.md`
- Spec draft: `lib/memory/features/timestamp-naming-conventions/spec.md`
- Thread artifact: `lib/inbox/threads/timestamp-naming-conventions/50991_0950_round-01-clarify.md`
- Round cap: `5`
...
5. Define migration scope for existing `lib/inbox/` artifacts, including
   `lib/inbox/threads/`.
...
- Closing artifact:
  `lib/inbox/threads/timestamp-naming-conventions/round-01-clarify-human-responses.md`
- Updated spec: `lib/memory/features/timestamp-naming-conventions/spec.md`
- Updated index: `lib/memory/features/timestamp-naming-conventions/index.json`

### Resolved decisions

1. Temporal-artifact scope includes `work/` directories plus all inbox artifacts
   under `lib/inbox/{in,out,threads,archive/in}`.
...
- `lib/inbox/threads/` parent folders: resolved from context by preserving the
...
- Handbook surface: resolved as in-scope for plan because the operator
  explicitly directed the rule into `lib/memory/handbook/inbox-lifecycle.md`.
