...
| file | change |
|---|---|
| `archive/work/173009_04-27-26/68576_0457_compliance-tests/compliance-audit.md` | Replaced previous pre-approval audit with post-`review_passes: true` full audit |
| `archive/work/173009_04-27-26/68576_0457_compliance-tests/compliance-remediation.md` | This file; updated to reflect current remediation outcomes |
| `archive/work/173009_04-27-26/68576_0457_compliance-tests/test-report.md` | Lines 27–29: replaced stale `lib/memory/features/...contracts/tests/*.yaml` citations with canonical `lib/internal/tests/compliance/*.yaml` citations |
| `archive/work/173009_04-27-26/68576_0457_compliance-tests/policy-compliance.json` | `changed_surfaces`: removed 5 deleted `lib/memory/features/...contracts/...` paths; added 5 canonical `lib/internal/tests/compliance/` paths |
