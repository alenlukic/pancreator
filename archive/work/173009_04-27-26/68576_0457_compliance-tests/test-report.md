...
PASS: MUST emit warning output to `lib/inbox/out`
CHECK: test descriptors include schema_ref/severity/assertion
PASS: lib/internal/tests/compliance/high-remediation-blocking.yaml
PASS: lib/internal/tests/compliance/medium-backlog-default-off.yaml
PASS: lib/internal/tests/compliance/low-warning-emission.yaml
```
