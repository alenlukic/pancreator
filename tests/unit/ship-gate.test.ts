...
function waiverFor(
  ...
  return {
    ...
    source_evidence_path: `runtime/logs/workflows/run-1/records/${item.invocation_id}.md`,
    ...
    artifact_path: `runtime/logs/workflows/run-1/artifacts/${item.stage}-waiver.md`,
    ...
    operator_feedback: [
      {
        ...
        attempt: 3,
        note: 'Skip review.',
        path: 'runtime/logs/workflows/run-1/artifacts/operator-feedback.md',
        timestamp: '2026-06-24T22:20:00.000Z',
      },
    ],
  } as RunState
