...
import { readJson, resolveInside, sha256, stableStringify, withFileLock, writeJsonAtomic } from "../../src/lib/io.mjs";
...
test("repository path resolution rejects escapes and locks serialize access", () => {
  const root = createFixture();
  assert.throws(() => resolveInside(root, "../escape"), /escapes repository root/);
