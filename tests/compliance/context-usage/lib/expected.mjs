...
export const SCENARIOS = {
  bounded_task: {
    id: "bounded_task",
    prompt_file: "tests/compliance/context-usage/prompt.md",
    expected_answers: {
  ...
  summary_first_routing: {
    ...
    prompt_file: "tests/compliance/context-usage/prompts/summary-first-routing.md",
    expected_answers: {
      product_route_token: "route-summary-only",
  ...
  simple_source_task: {
    ...
    prompt_file: "tests/compliance/context-usage/prompts/simple-source-task.md",
    expected_answers: {
      handler_export_count: 2,
    },
    forbidden_path_patterns: [
  ...
  generated_artifact_preference: {
    ...
    prompt_file: "tests/compliance/context-usage/prompts/generated-artifact-preference.md",
    expected_answers: {
  ...
  explicit_read_generated_index: {
    ...
    prompt_file: "tests/compliance/context-usage/prompts/explicit-read-generated-index.md",
    expected_answers: {
