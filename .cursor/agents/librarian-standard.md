...
description: "Standard economical `librarian` subagent. Use for bounded, routine, or simple-task-mode work that should let Cursor auto-select an economical model."
model: auto
