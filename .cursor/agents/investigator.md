...
tools: [Read, Grep, Glob, "Bash(git diff:*)", "Bash(git status:*)", "Bash(npm test:*)", "Bash(npm run:*)", "Bash(node:*)"]
disallowedTools: [Write, Edit, "Bash(git commit:*)", "Bash(git push:*)", "Bash(git reset --hard:*)", "Bash(rm:*)", "Bash(./bin/pan set-stage:*)"]
maxTurns: 30
---
