...
8. Read `lib/personas/pr-writer.md` **PR body output contract** only when preparing final output emission; do not use a Test plan template or run `gh pr create`.
