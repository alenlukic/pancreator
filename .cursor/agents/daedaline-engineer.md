...
description: "Backward-compatible standard alias for `daedaline-engineer-standard`. Use for routine daedaline-engineer work; invoke `daedaline-engineer-complex` when the task is ambiguous, cross-cutting, policy-sensitive, or explicitly escalated."
model: gpt-5.3-codex
