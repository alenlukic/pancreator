---
name: daedaline-engineer-complex
description: "Complex high-effort `daedaline-engineer` subagent. Use only when standard mode is insufficient: ambiguous architecture, policy/compliance reasoning, broad repo audit, historical reconstruction, or high-risk cross-cutting work."
...
metadata:
  ...
  daedaline-base-persona: daedaline-engineer
  daedaline-model-tier: complex
  daedaline-canonical-persona: src/personas/daedaline-engineer.md
---

# daedaline-engineer-complex

This file is a compact Cursor projection for the canonical persona at
`src/personas/daedaline-engineer.md`. It intentionally avoids duplicating persona prose,
...
2. Read `src/personas/daedaline-engineer.md` for role semantics before performing persona-owned work.
...
- `daedaline-engineer-standard` is the default for bounded or routine work; its model is selected by the current frontmatter policy.
- `daedaline-engineer-complex` preserves the prior fixed model selection for reasoning-heavy work.
- `daedaline-engineer` is a backward-compatible standard alias unless an operator explicitly asks for the complex tier.
