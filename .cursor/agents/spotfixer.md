...
tools: [Read, Grep, Glob, Write, Edit, "Bash(git diff:*)", "Bash(git status:*)", "Bash(npm test:*)", "Bash(npm run:*)", "Bash(node:*)"]
disallowedTools: ["Bash(git commit:*)", "Bash(git push:*)", "Bash(git reset --hard:*)", "Bash(rm:*)", "Bash(./bin/pan set-stage:*)"]
maxTurns: 45
---
