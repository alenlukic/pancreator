...
description: "Backward-compatible standard alias for `pancreator-engineer-standard`. Use for routine pancreator-engineer work; invoke `pancreator-engineer-complex` when the task is ambiguous, cross-cutting, policy-sensitive, or explicitly escalated."
model: gpt-5.3-codex
