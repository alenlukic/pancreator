...
- **Q11 (new).** *Conversation Mode persistence.* Threads in `/inbox/threads/` — cap on retained turns before summarization? Default proposed: **last 100 turns verbatim + Librarian rolling summary**.
