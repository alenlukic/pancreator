...
When `coder` reconciles package inventory, existing `internal/packages/@tesseract/*` directories MUST remain in place. The unscoped `internal/packages/tesseract/` meta package MUST be added because PRD §11 names the `tesseract` meta package.
