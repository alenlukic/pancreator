...
- `internal/tools/context-budget-report.mjs` — exercised by `node --test internal/tools/context-budget-report.test.mjs` (spawns script, asserts stdout markers).
...
`internal/tools/context-budget-report.test.mjs` (lines 1–18), which covers the CLI
