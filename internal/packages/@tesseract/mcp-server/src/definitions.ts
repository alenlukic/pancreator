...
export function listToolDefinitions(): readonly ToolDefinition[] {
  return [
    ...
    {
      name: "tess.inbox",
      description: "List pending human directives under inbox/in/",
      inputSchema: EMPTY_OBJECT_SCHEMA,
    },
    {
      name: "tess.feature",
...
/**
 * The resource templates SHALL cover `/memory/`, Inbox, and `work/<taskId>/run.log.jsonl` reads.
 */
  ...
  return [
    {
      ...
      uriTemplate: "memory://",
      description:
        "JSON text listing one Memory directory name for each child of `/memory/`.",
    ...
    },
    {
      ...
      uriTemplate: "inbox://",
      description:
        "JSON text listing file names in `inbox/in/`, `inbox/out/`, and `inbox/threads/`.",
      mimeType: "application/json",
    },
    {
