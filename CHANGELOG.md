...
- Name `planning` as the default systematic workflow in the embedded operating card. Drop `--workflow delivery` from the installer's post-install next step ([embedded card](library/templates/embedded-AGENTS.md), [install](bin/install)).
