...
- Record the routing rule's surfaces as a retained duplication in the context-bloat dispositions: the policy, the orchestrator brief, the `/pan-start` command, and the primer ([dispositions](governance/registries/context_bloat_dispositions.json)).
