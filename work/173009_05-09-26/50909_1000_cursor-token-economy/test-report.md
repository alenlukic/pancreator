...
- `tools/context-budget-report.mjs` — exercised by `node --test tools/context-budget-report.test.mjs` (spawns script, asserts stdout markers).
...
`tools/context-budget-report.test.mjs` (lines 1–18), which covers the CLI
