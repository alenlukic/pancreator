...
#   - "memory/handbook/constitution.md:[108,116]#00874481f8aaaa6618a4b6ab4d3d115ebfffd5dcf61d3d2ef38bb2076ed17432"
#   - "memory/handbook/policy-compliance-contract.md:[49,55]#6a7a1e5d27a3c1c0dec59b19c5267e817ea03dcef969b2eba3d6c11cc42a228a"
# custom:
...
is_contract_path(path) if {
  startswith(path, "memory/features/")
  contains(path, "/contracts/")
}

is_governance_path(path) if startswith(path, "AGENTS.md")
is_governance_path(path) if startswith(path, "memory/handbook/")
is_governance_path(path) if startswith(path, "personas/")
