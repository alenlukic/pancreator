...
| file | change |
|---|---|
| `work/173009_04-27-26/68576_0457_compliance-tests/compliance-audit.md` | Replaced previous pre-approval audit with post-`review_passes: true` full audit |
| `work/173009_04-27-26/68576_0457_compliance-tests/compliance-remediation.md` | This file; updated to reflect current remediation outcomes |
| `work/173009_04-27-26/68576_0457_compliance-tests/test-report.md` | Lines 27–29: replaced stale `memory/features/...contracts/tests/*.yaml` citations with canonical `tests/compliance/*.yaml` citations |
| `work/173009_04-27-26/68576_0457_compliance-tests/policy-compliance.json` | `changed_surfaces`: removed 5 deleted `memory/features/...contracts/...` paths; added 5 canonical `tests/compliance/` paths |
