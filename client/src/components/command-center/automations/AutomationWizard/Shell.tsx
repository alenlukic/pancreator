  ...
  return (
    <section className="automation-wizard" data-testid="automation-wizard">
      ...
      <footer className="automation-wizard-footer">
        <button type="button" className="command-center-action-button" onClick={onClose}>
          Cancel
        </button>
        {stepIndex > 0 ? (
          <button type="button" className="command-center-action-button" onClick={handleBack}>
            Back
          </button>
        ) : null}
        {step !== "Review" ? (
          <button type="button" className="command-center-action-button" onClick={handleNext}>
            Next
          </button>
        ) : (
          <button
