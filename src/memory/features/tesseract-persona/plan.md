...
## Touch Set
- `src/internal/packages/@tesseract/persona/**`
- `src/memory/features/tesseract-persona/contracts/**`
- `src/memory/features/tesseract-persona/spec.md`
- `src/memory/features/tesseract-persona/plan.md`
- `src/memory/features/tesseract-persona/tasks.md`

## Execution Steps
1. Implement and organize package files so they satisfy `tesseract.persona.package_shape`.
2. Draft and maintain a README Quickstart flow that satisfies `tesseract.persona.readme_ergonomics`.
