...
## Touch Set
- `src/internal/packages/@tesseract/env-isolation/**`
- `src/memory/features/tesseract-env-isolation/contracts/**`
- `src/memory/features/tesseract-env-isolation/spec.md`
- `src/memory/features/tesseract-env-isolation/plan.md`
- `src/memory/features/tesseract-env-isolation/tasks.md`
