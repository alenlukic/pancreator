...
- `src/memory/features/tesseract-checkpointer-fs/contracts/**`
- `src/memory/features/tesseract-checkpointer-fs/spec.md`
- `src/memory/features/tesseract-checkpointer-fs/plan.md`
- `src/memory/features/tesseract-checkpointer-fs/tasks.md`
