# Task List - @daedaline/pipeline

- [x] T1: Confirm package scaffold and exported surface satisfy `daedaline.pipeline.package_shape`.
- [x] T2: Confirm README Quickstart satisfies `daedaline.pipeline.readme_ergonomics` (manual review; LLM-judge contract deferred to CI).
