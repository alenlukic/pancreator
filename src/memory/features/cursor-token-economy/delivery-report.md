...
- Cursor rule activation narrows to reduce default context load, and `pancreator-engineer` drops broad `src/work/**/*` activation unless the rule targets run logs, plans, reviews, or delivery reports. 
