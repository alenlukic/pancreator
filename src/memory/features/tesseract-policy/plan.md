...
## Touch Set
- `src/internal/packages/@tesseract/policy/**`
- `src/memory/features/tesseract-policy/contracts/**`
- `src/memory/features/tesseract-policy/spec.md`
- `src/memory/features/tesseract-policy/plan.md`
- `src/memory/features/tesseract-policy/tasks.md`
