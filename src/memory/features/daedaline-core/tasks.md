# Task List - @daedaline/core

- [x] T1: Confirm package scaffold and exported surface satisfy `daedaline.core.package_shape`.
- [x] T2: Confirm README Quickstart satisfies `daedaline.core.readme_ergonomics`.
