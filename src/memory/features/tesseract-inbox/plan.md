...
## Touch Set
- `src/internal/packages/@tesseract/inbox/**`
- `src/memory/features/tesseract-src/inbox/contracts/**`
- `src/memory/features/tesseract-src/inbox/spec.md`
- `src/memory/features/tesseract-src/inbox/plan.md`
- `src/memory/features/tesseract-src/inbox/tasks.md`
