# Task List - @daedaline/intervention

- [x] T1: Package scaffold and exports satisfy `daedaline.intervention.package_shape` (`package.json`, `README.md`, `src/index.ts`).
- [x] T2: README Quickstart lists explicit `pnpm` commands for install, build, test, and typecheck (`daedaline.intervention.readme_ergonomics`).
...
- [ ] **Deferred:** `@daedaline/cli` wiring for `ddl pause | resume | abort` (Phase 3 step 8).
