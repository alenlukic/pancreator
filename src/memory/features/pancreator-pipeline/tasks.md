# Task List - @pancreator/pipeline

- [x] T1: Confirm package scaffold and exported surface satisfy `pancreator.pipeline.package_shape`.
- [x] T2: Confirm README Quickstart satisfies `pancreator.pipeline.readme_ergonomics` (manual review; LLM-judge contract deferred to CI).
...
- Repository `src/pipelines/*.yaml` MVP content (directory still placeholder).
