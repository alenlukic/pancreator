...
source_inbox_item: src/inbox/in/phase-4-dogfood-proof-bundle-index.md
...
intake_closure:
  ...
  note: |
    ...
    by `tess run feature-delivery phase-4-dogfood-proof-bundle-index.md`
...
`src/memory/features/us-1-dogfood-phase-4-exit/phase-4-proof-bundle.md` with
