---
title: Engineering Spec - @tesseract/contract-style
...
## Requirements
- The package implementation MUST satisfy contract `tesseract.contract_style.package_shape` for `src/internal/packages/@tesseract/contract-style/**`.
