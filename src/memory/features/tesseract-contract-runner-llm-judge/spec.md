...
## Requirements
- The package implementation MUST satisfy contract `tesseract.contract_runner_llm_judge.package_shape` for `src/internal/packages/@tesseract/contract-runner-llm-judge/**`.
