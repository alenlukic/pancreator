...
## Touch Set
- `src/internal/packages/@tesseract/contract-runner-llm-judge/**`
- `src/memory/features/tesseract-contract-runner-llm-judge/contracts/**`
- `src/memory/features/tesseract-contract-runner-llm-judge/spec.md`
- `src/memory/features/tesseract-contract-runner-llm-judge/plan.md`
- `src/memory/features/tesseract-contract-runner-llm-judge/tasks.md`
