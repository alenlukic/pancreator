...
- `src/memory/features/tesseract-pipeline/contracts/**`
- `src/memory/features/tesseract-pipeline/spec.md`
- `src/memory/features/tesseract-pipeline/plan.md`
- `src/memory/features/tesseract-pipeline/tasks.md`
