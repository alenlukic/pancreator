...
applies_to:
  ...
  path: /src/memory/features/<id>/ux-spec.md
...
metadata:
  ...
  tesseract.applies_to: artifact-symbol:/src/memory/features/<id>/ux-spec.md#<symbol>
...
metadata:
  ...
  tesseract.applies_to: artifact-symbol:/src/memory/features/<id>/ux-spec.md#Color-and-Contrast
...
spec: /src/memory/features/<id>/contracts/focus-trap.spec.ts
runtime:
  test_describe: <feature>.ux.focus-trap
metadata:
  tesseract.contract_id: <feature>.ux.focus-trap
  tesseract.applies_to: artifact-symbol:/src/memory/features/<id>/ux-spec.md#Modal-Focus-Behavior
