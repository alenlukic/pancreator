...
`{kind: lines, path: src/memory/features/active-memory-context-economy-pass-2/spec.md, range: [191, 210], contentHash: e6c4fcd}`.
...
Citations:
`{kind: lines, path: src/memory/adr/0003-inbox-lifecycle-and-archival.md, range: [52, 64], contentHash: 994081b}`;
`{kind: lines, path: src/memory/adr/0004-documentation-impact-contract.md, range: [37, 47], contentHash: d77cc5c}`;
`{kind: lines, path: src/memory/adr/0005-timestamp-naming-conventions.md, range: [35, 47], contentHash: a548b88}`.
...
remaining undefined.
Citation:
`{kind: lines, path: src/internal/work_archive/172997_05-09-26/3900_2255_plan-active-memory-context-economy-pass-2/plan.md, range: [47, 47], contentHash: 58bbab6}`.
...
`{kind: lines, path: src/memory/features/active-memory-context-economy-pass-2/spec.md, range: [275, 286], contentHash: e6c4fcd}`
