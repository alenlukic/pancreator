...
`src/work/` is the active run workspace. New or in-progress pipeline artifacts live
here while an operator or agent is still using them.

Completed run artifacts move to `src/internal/work_archive/` during librarian
