 ...
 *
 * Usage:
 *   node src/internal/tools/refresh-tbd-contenthash.mjs [--dry-run|--write]
 *
 * @see src/memory/handbook/glossary.md (contentHash)
 */
...
import { resolveAbbrevLen } from "./canonical-json-format.mjs";
...
const EXCLUDED_FILES = new Set([
  ...
  "src/internal/tools/reformat-markdown-citations.mjs",
  "src/internal/tools/migrate-timestamp-naming.mjs",
  "src/internal/tools/refresh-tbd-contenthash.mjs",
]);
...
function isExcludedPath(posixRel) {
  ...
  if (norm.startsWith("src/memory/handbook/contract-templates/")) {
    return true;
  }
