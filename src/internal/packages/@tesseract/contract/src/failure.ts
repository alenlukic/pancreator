import type { ContentHash } from "@tesseract/core";

import type { ContractClause } from "./wrapper.js";

/**
 * Record returned when a contract gate fails, aligned with the failure shape in `/src/memory/handbook/contract-format.md`.
 */
