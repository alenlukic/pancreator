...
/** Fallback when a deferred verb lacks a dedicated intake — mirror `deferredToolTrackingIntake` in `@pancreator/mcp-server/src/pan-execute.ts`. */
const BATCH_DEFERRAL_TRACKING_INTAKE =
  "src/inbox/in/172981_05-25-26/64488_0605_cli-operator-tooling-batch.md";
/** `pan init` / MCP `pan.init` deferral tracker — mirror `deferredToolTrackingIntake` in `@pancreator/mcp-server/src/pan-execute.ts`. */
