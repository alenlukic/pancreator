...
|---|---|---|---|
| `pan.inbox` | `{}` | `inbox` | Lists `src/inbox/in/` entries. |
| `pan.feature` | `{ "action": "list" }` | `feature.list` | Summaries from `src/memory/features/*/index.json`. |
| `pan.feature` | `{ "action": "show", "featureId": "<id>" }` | `feature.show` | Returns index JSON and `spec.md` when present. |
| `pan.status` | `{}` or `{ "taskId": "<id>" }` | `status` | Workspace bootstrap snapshot plus optional task-scoped ledger read. |
...
|---|---|---|
| `pan.init` | M3 | `src/inbox/in/172981_05-25-26/64500_0605_pan-init-and-create-pancreator-install-paths.md` |
| `pan.run` | M2 | `src/inbox/in/172981_05-25-26/64488_0605_cli-operator-tooling-batch.md` |
| `pan.approve` | M3 | `src/inbox/in/172981_05-25-26/64488_0605_cli-operator-tooling-batch.md` |
| `pan.contracts` | M2 | `src/inbox/in/172981_05-25-26/64488_0605_cli-operator-tooling-batch.md` |
| `pan.lint` | M1 | `src/inbox/in/172981_05-25-26/64488_0605_cli-operator-tooling-batch.md` |
