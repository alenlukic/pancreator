...
/**
 * MCP deferred-tool `tracking_intake` routing: mirror `@pancreator/cli/src/run.ts`
...
export function deferredToolTrackingIntake(name: DdlToolName): string {
  if (name === "pan.init") {
    return "src/inbox/in/172981_05-25-26/64500_0605_pan-init-and-create-pancreator-install-paths.md";
  }
