...
const dependencyEntries = [
  path.join(packageRoot, "node_modules", "@pancreator", "core", "dist", "index.js"),
  path.join(packageRoot, "node_modules", "@pancreator", "inbox", "dist", "index.js"),
  path.join(packageRoot, "node_modules", "@pancreator", "intervention", "dist", "index.js"),
  path.join(packageRoot, "node_modules", "@pancreator", "memory", "dist", "index.js"),
  path.join(packageRoot, "node_modules", "@pancreator", "run-logger", "dist", "index.js"),
];
...
if (needsBuild) {
  const result = spawnSync("pnpm", ["--dir", repoRoot, "--filter", "@pancreator/mcp-server...", "run", "build"], {
    cwd: repoRoot,
    stdio: "inherit",
  });
  if (result.status !== 0) {
