/**
 * Canonical threshold-policy document shape for `ddl upgrade --apply` consumers.
 * Version 1 aligns loosely with `daedaline.yaml` / `daedaline-defaults.yaml` keys.
 */
...
export interface PolicyConfigV1 {
  schemaVersion: 1;
  /**
   * Absolute path or path relative to the directory containing daedaline.yaml.
