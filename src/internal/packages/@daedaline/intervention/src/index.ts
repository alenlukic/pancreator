...
export const DAEDALINE_INTERVENTION_VERSION = "0.0.0" as const;
...
/** @deprecated Prefer `DAEDALINE_INTERVENTION_VERSION`. */
export const DAEDALINE_INTERVENTION_STUB = "intervention" as const;
