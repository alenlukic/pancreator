...
/**
 * Parses the routing table in `/src/memory/handbook/index.md` (glossary: MemoryRouter).
 */
...
/**
 * The system SHALL read `/src/memory/handbook/index.md` and return top matches for a
