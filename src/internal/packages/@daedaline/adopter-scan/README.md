...
```bash
pnpm add @daedaline/adopter-scan
pnpm --filter @daedaline/adopter-scan run build
pnpm --filter @daedaline/adopter-scan run test
```

```typescript
import { scanRepository } from "@daedaline/adopter-scan";
