...
| `pancreator.features.timestamp_naming.migration_precedence` | tests | block    | deferred-runner-not-wired (test pass)        | `pnpm migration:test` exercises four `chooseTimestamp` precedence cases (git, frontmatter, mtime, override) and exits 18/18 green. Citation: `{kind: lines, path: src/internal/tools/migrate-timestamp-naming.test.mjs, range: [115, 152], contentHash: TBD-on-commit}`. |
| `pancreator.features.timestamp_naming.reference_update_audit` | tests | block    | deferred-runner-not-wired (script pass)      | `node src/internal/tools/migrate-timestamp-naming.mjs --dry-run --strict-references` returns exit 0 with `strictReferenceAudit.staleRows: []`. Citation: `{kind: lines, path: src/internal/tools/migrate-timestamp-naming.mjs, range: [789, 818], contentHash: TBD-on-commit}`. |
...
| P3 | Write mode requires `PANCREATOR_MIGRATION_GO=1` AND `--write`.                                        | pass   | `{kind: lines, path: src/internal/tools/migrate-timestamp-naming.mjs, range: [896, 921], contentHash: TBD-on-commit}` (env-var guard with stderr message and non-zero exit when missing)                                                                                                                                                                                                                                                                          |
...
| 3 | `src/internal/work_archive/173009_04-27-26/55075_0842_pancreator-worktree-env-isolation-impl/`                     | 2026-04-27T08:42:05Z      | 173009   | 04-27-26  | 55075      | 0842 | `pancreator-worktree-env-isolation-impl`           | `src/internal/work_archive/173009_04-27-26/55075_0842_pancreator-worktree-env-isolation-impl/`                   | pass   |
| 4 | `src/internal/work_archive/173009_04-27-26/55309_0838_pancreator-persona-pipeline-runner-impl/`                    | 2026-04-27T08:38:11Z      | 173009   | 04-27-26  | 55309      | 0838 | `pancreator-persona-pipeline-runner-impl`          | `src/internal/work_archive/173009_04-27-26/55309_0838_pancreator-persona-pipeline-runner-impl/`                  | pass   |
| 5 | `src/internal/work_archive/173009_04-27-26/55884_0828_pancreator-observability-impl/`                              | 2026-04-27T08:28:36Z      | 173009   | 04-27-26  | 55884      | 0828 | `pancreator-observability-impl`                    | `src/internal/work_archive/173009_04-27-26/55884_0828_pancreator-observability-impl/`                            | pass   |
