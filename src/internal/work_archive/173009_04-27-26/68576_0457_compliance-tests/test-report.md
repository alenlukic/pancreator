...
PASS: MUST emit warning output to `src/inbox/out`
CHECK: test descriptors include schema_ref/severity/assertion
PASS: src/internal/tests/compliance/high-remediation-blocking.yaml
PASS: src/internal/tests/compliance/medium-backlog-default-off.yaml
PASS: src/internal/tests/compliance/low-warning-emission.yaml
```
