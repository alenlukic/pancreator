...
- Added `OPERATION.md` routes in `AGENTS.md`, `docs/M1.index.md`, and `src/memory/handbook/tesseract-config.md`.
...
- Fixed bare `tess` prose invocations in coder, intake-analyst, reviewer, supervisor, tech-lead, tech-writer, librarian personas.
...
| Handbook deferred-verb prose (`tess inbox archive`, etc.) | Not runnable blocks; existing backlog items cover automation |
...
2. **What:** Advance the run to review after accepting the implementation artifact.  
   **How:** Run:
   ...
   ```bash
   pnpm -w exec tess advance 16224_1929_bootstrap-de-hacking-pass-simplify-ops-docs-and-memory-layout --artifact src/work/172979_05-27-26/16224_1929_bootstrap-de-hacking-pass-simplify-ops-docs-and-memory-layout/implementation-report.md
   ```
