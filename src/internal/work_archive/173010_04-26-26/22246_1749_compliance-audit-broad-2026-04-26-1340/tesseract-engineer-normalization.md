...
- Delegation result:
  - `normalized_contract_path`: `/src/memory/features/tesseract-policy/contracts/tesseract.governance.normalize-dual-anchor-contenthash-corpus.yaml`
  - `contracts_index_update`: append clause recommendation to `/src/memory/features/tesseract-policy/contracts.index.json` for `tesseract.governance.normalize-dual-anchor-contenthash-corpus`.
