...
- Delegation result:
  - `normalized_contract_path`: `/src/memory/features/pancreator-policy/contracts/pancreator.governance.normalize-dual-anchor-contenthash-corpus.yaml`
  - `contracts_index_update`: append clause recommendation to `/src/memory/features/pancreator-policy/contracts.index.json` for `pancreator.governance.normalize-dual-anchor-contenthash-corpus`.
