...
| `pnpm -w exec pan run feature-delivery src/inbox/in/172980_05-26-26/2597_2316_m1-substrate-runtime-batch.md` | 0 | pass | Full inbox path accepted after strip/join fix |
...
const { CursorRunner } = await import('./src/internal/packages/@pancreator/runner-cursor/dist/index.js');
...
```sh
cd /Users/alen/Dev/pancreator
pnpm -w exec pan advance 966_2343_m1-substrate-runtime-batch-harness-loop-install-paths-library-mode-phoenix-confo --artifact src/work/172980_05-26-26/966_2343_m1-substrate-runtime-batch-harness-loop-install-paths-library-mode-phoenix-confo/implementation-report.md
```
...
- **Impact:** Read-only except `pan run feature-delivery`, which creates a new active-work directory under `src/work/` (use a throwaway inbox entry if you want to avoid clutter).
