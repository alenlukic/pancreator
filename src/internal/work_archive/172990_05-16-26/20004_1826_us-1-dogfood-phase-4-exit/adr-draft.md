...
The proof bundle also depends on documentation-impact discipline because Phase 4 ratification can update `pancreator.yaml`, active memory, and operator guidance. ADR 0004 requires each task to record documentation and reference impact: `{kind: lines, path: src/memory/adr/0004-documentation-impact-contract.md, range: [49, 75], contentHash: f0ee449a848d71b22c21dec91d0581392e8e556c2537fc3dfe169e02db642a8c}`.
