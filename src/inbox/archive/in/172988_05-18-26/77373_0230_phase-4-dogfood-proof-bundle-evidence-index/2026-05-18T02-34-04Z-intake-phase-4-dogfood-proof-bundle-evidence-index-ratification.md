...
by executing `tess run feature-delivery phase-4-dogfood-proof-bundle-index.md`;
...
```
pnpm -w exec tess advance 77373_0230_phase-4-dogfood-proof-bundle-evidence-index --artifact src/memory/features/phase-4-dogfood-proof-bundle-evidence-index/spec.md
```
