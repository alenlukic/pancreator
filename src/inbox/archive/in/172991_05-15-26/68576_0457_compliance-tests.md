...
- Follow-ups: severity-based
    - High/blocker: invoke remediation pipeline (e.g. failures -> contract writer -> Pancreator engineer); if gating agent activity, then gate is blocked until remediation in place
