...
| Q6 | Migration ownership | One-shot bulk script run by `tesseract-engineer`. |
...
dual-anchor citations. The glossary (`src/memory/handbook/glossary.md` lines
...
Please ratify the spec at `src/memory/features/json-formatting/spec.md` and
