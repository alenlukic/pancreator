  ...
  async function runCompliance(descriptorId?: string) {
    ...
    const command =
      descriptorId === undefined
        ...
        : `node lib/internal/tools/compliance/run-compliance.mjs ${descriptorId}`;
      ...
      <div className="compliance-audit-triggers">
        ...
        <div className="compliance-descriptor-list">
          {descriptors.map((descriptor) => {
            ...
            const runCommand = `node lib/internal/tools/compliance/run-compliance.mjs ${descriptor.id}`;
            return (
              <article
                key={descriptor.id}
