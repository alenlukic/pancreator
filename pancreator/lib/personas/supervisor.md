...
metadata:
  ...
  pancreator-pipeline-stages: [bookkeeping, intervention-dispatch, pipeline-supervisor]
...
- You MUST limit execution to invocation stages: `ship, intervention-dispatch, pipeline-supervisor`.
...
- You MUST emit a durable stage-transition summary artifact for every transition, including status, decision, evidence paths, and deterministic next operator steps.
