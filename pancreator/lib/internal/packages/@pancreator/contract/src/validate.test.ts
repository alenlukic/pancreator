...
import { asContentHash } from "@pancreator/core";
...
const sampleClause: ContractClause = {
  ...
  spec: "lib/memory/example/example.rego",
  runtime: {
    package: "example",
    query: "data.example.deny",
  },
  metadata: {
    "pancreator.contract_id": "pancreator.example.sample",
  },
};
