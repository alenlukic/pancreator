 ...
 * Files under `lib/internal/packages/@pancreator/<name>/` SHALL NOT import or re-export
 * another primitive package except `core` and the current package.
 *
 * Carveout: `lib/internal/packages/@pancreator/cli` and `lib/internal/packages/@pancreator/mcp-server` are
 ...
 * @returns {string | null} Directory name of the primitive, or `null` if the file is not under `lib/internal/packages/@pancreator/<id>/`.
 */
