 ...
 *
 * Usage:
 *   node lib/internal/tools/governance/audit-governance-usage.mjs [--window 14d] [--out PATH] [--stdout-only]
 */
...
\`\`\`bash
# this report
node lib/internal/tools/governance/audit-governance-usage.mjs --window ${windowDays}d
