...
The migration tool `lib/internal/tools/migrations/migrate-inbox-convention.mjs` SHALL run
...
```bash
node lib/internal/tools/migrations/migrate-inbox-convention.mjs --prune-empty-dirs --dry-run
node lib/internal/tools/migrations/migrate-inbox-convention.mjs --prune-empty-dirs --write
```
