# Operator section
- 👀 **In this file:** Pancreator Glossary
- ⚖️ **Why it matters:** Quick orientation for Pancreator Glossary before agents load the full contract.
- 🧭 **See also:**
  - kind: lines
  - kind: lines
  - kind: lines
...
- **Dual-anchor citation** — a cross-reference serialized as JSON. Preferred `"kind"` is `symbol`
  ...
  with the json-formatting canonical printer (`lib/internal/tools/migrations/migrate-json-formatting.mjs`,
