...
The operator SHOULD run `pnpm run context:budget` (or `node lib/internal/tools/context/context-budget-report.mjs`) before and after policy changes to capture directional corpus size estimates.
