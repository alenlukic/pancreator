...
| Expensive fixed models used for every subagent invocation | Named personas use the canonical `.cursor/agents/<name>.md` projection; ad-hoc delegations use the parent model per `AGENTS.md` §2. |
