...
import { resolveAbbrevLen } from "../lib/internal/tools/format/canonical-json-format.mjs";

const ROOT = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "..");
const TOOL = path.join(ROOT, "lib/internal/tools/format/refresh-tbd-contenthash.mjs");
