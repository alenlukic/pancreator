...
3. Run `./bin/pan governance card --mode decomposition` and read the card it writes. It resolves the complete decomposition governance, including `DECOMP-001`; do not assemble policy text by hand.
