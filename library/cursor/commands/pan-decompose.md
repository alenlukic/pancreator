...
3. Invoke the `pan-decomposer` subagent with the original input and output path. Require it to apply `DECOMP-001`, default to retaining one larger systematic run, and write no other file.
