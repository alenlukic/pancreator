...
2. Choose a unique output path under `{{PANCREATOR_HARNESS_PATH}}runtime/inbox/` named `decomposition-<UTC timestamp>-<slug>.md`. Retain the harness-relative path for Pancreator CLI arguments.
