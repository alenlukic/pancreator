...
1. Read `AGENTS.md` and preserve `$ARGUMENTS` verbatim as the spotfix input.
...
3. Invoke the `spotfixer` subagent with the preserved input. The subagent MUST apply `library/skills/spotfix.md`, including eligibility checks, acceptance criteria, proportionate tests, at most three implementation-validation cycles, and systematic escalation when required.
