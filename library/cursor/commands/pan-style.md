...
6. When the scan reports one to five editable files with issues, open each editable file. Repair the reported code style issues, plus the judgment-level rules the style guidance states.
