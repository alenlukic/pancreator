...
7. For a paused bound run, use `{{PANCREATOR_PAN_COMMAND}} resume <run-id> --worktree <name>`.
8. For a bound run, use `{{PANCREATOR_PAN_COMMAND}} prepare <run-id> --worktree <name>`.
