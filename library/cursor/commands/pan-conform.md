...
6. When the scan reports one to five editable files with issues, open each editable file and repair the reported Simplified Technical English issues. Edit only `CHANGELOG.md`, `docs/issues/**/*.md`, and `runtime/pr-descriptions/*.md`.
7. Do not edit rendered HTML. Report its issues only.
