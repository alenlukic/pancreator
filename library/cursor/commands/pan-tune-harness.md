...
4. Collect one KEEP, MERGE, DEMOTE, or DELETE verdict per current test identity. Every verdict MUST cite a TP identifier and concrete evidence. MERGE MUST name a survivor. DELETE MUST name a permitted sub-reason. DEMOTE MUST name a documented lane destination or a cheaper direct form.
