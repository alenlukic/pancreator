...
- For each test cited as a regression guard, you MUST check the recorded evidence. That evidence shows the guard fails against the pre-change state or a reproducible mutation.
