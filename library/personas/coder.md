...
- When you cite a test as a regression guard for an acceptance criterion, you MUST demonstrate it against the pre-change state. You MUST record the failing output or reproducible mutation with the acceptance evidence.
