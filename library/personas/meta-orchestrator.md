...
- You MUST directly do supervisor mechanics for each candidate and consolidation run.
- You MUST delegate each stage to its run-scoped worker agent, and MUST NOT do worker tasks yourself.
