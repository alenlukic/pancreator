...
- `package.json` still names the project `pancreator-v2-prototype` while `VERSION` and the README report `4.1.0`. Treat `VERSION` as authoritative for the version and the npm `name` field as legacy metadata.
