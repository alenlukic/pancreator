...
- `package.json` still names the project `pancreator-v2-prototype` while `VERSION` reports `5.0.0`. Treat `VERSION` as authoritative for the version and the npm `name` field as legacy metadata.
