...
import type { FeatureId } from "@tesseract/core";

/**
 * Mem0-shaped key-value view over a repository `memory/` tree.
 */
...
export class FileMemoryStore implements MemoryStore {
  ...
  /**
   * @param memoryRoot - Absolute path to the repository `memory/` directory.
   */
  ...
  /**
   * The system SHALL read `memory/features/<id>/index.json` when present.
   */
  ...
  /**
   * The system SHALL write `memory/features/<id>/index.json` as formatted JSON.
   */
