...
/**
 * Bidirectional queue access for `/inbox/in/`, `/inbox/out/`, and `/inbox/threads/`
 * (glossary: Inbox).
 */
...
/**
 * The system SHALL resolve child paths under `inbox/` without allowing `..`
...
export class FileInbox implements Inbox {
  ...
  /**
   * @param repositoryRoot - Absolute path to the repository root that contains `inbox/`.
   */
