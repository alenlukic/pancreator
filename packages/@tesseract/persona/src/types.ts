...
/** Closed `permissionMode` values from `/memory/handbook/persona-spec.md` §2. */
export type PersonaPermissionMode = "default" | "read-only";

/** Closed `isolation` values from `/memory/handbook/persona-spec.md` §2. */
export type PersonaIsolation = "worktree" | "none";

/** Closed `memory` values from `/memory/handbook/persona-spec.md` §2. */
export type PersonaMemory = "project" | "private";

/** Closed `effort` values from `/memory/handbook/persona-spec.md` §2. */
export type PersonaEffort = "low" | "medium" | "high";

/**
 * Tesseract extension block from `/memory/handbook/persona-spec.md` §3.
...
/**
 * Result of parsing `personas/<name>.md`: validated spec, raw body, and full frontmatter
