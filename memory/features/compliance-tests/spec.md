...
references:
  ...
  - kind: lines
    path: inbox/threads/compliance-tests/round-01.md
    range: [1, 30]
  ...
  - kind: lines
    path: inbox/threads/compliance-tests/round-02.md
    range: [1, 17]
  ...
  - kind: lines
    path: inbox/threads/compliance-tests/round-05-human-approve.md
    range: [1, 3]
    contentHash: TBD-on-commit
