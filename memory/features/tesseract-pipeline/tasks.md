...
- [ ] T1: Confirm package scaffold and exported surface satisfy `tesseract.pipeline.package_shape`.
- [ ] T2: Confirm README Quickstart satisfies `tesseract.pipeline.readme_ergonomics`.
