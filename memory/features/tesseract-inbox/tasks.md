...
- [ ] T1: Confirm package scaffold and exported surface satisfy `tesseract.inbox.package_shape`.
- [ ] T2: Confirm README Quickstart satisfies `tesseract.inbox.readme_ergonomics`.
