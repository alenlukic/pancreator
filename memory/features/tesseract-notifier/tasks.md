...
- [ ] T1: Confirm package scaffold and exported surface satisfy `tesseract.notifier.package_shape`.
- [ ] T2: Confirm README Quickstart satisfies `tesseract.notifier.readme_ergonomics`.
