...
- [ ] T1: Confirm package scaffold and exported surface satisfy `tesseract.mcp_server.package_shape`.
- [ ] T2: Confirm README Quickstart satisfies `tesseract.mcp_server.readme_ergonomics`.
