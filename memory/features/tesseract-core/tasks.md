# Task List - @tesseract/core

- [ ] T1: Confirm package scaffold and exported surface satisfy `tesseract.core.package_shape`.
- [ ] T2: Confirm README Quickstart satisfies `tesseract.core.readme_ergonomics`.
