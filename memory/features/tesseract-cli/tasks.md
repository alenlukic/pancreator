...
- [ ] T1: Confirm package scaffold and exported surface satisfy `tesseract.cli.package_shape`.
- [ ] T2: Confirm README Quickstart satisfies `tesseract.cli.readme_ergonomics`.
