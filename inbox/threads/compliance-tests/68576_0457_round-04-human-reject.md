...
The instructions encoded @ `internal/work_archive/173009_04-27-26/68576_0457_compliance-tests/plan.md` deviated from operator guidance provided @ `inbox/threads/compliance-tests/68576_0457_round-01.md`, which subsequently poisoned the entire pipeline.
