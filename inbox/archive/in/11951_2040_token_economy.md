...
This task SHALL NOT hide `PRD.md`, `BOOTSTRAP.md`, `memory/`, or `work/` from explicit human or agent access. The desired behavior is “not default indexed / not default loaded,” not “unavailable.”
...
```yaml
globs: ["AGENTS.md", "BOOTSTRAP.md", "memory/**/*", "personas/**/*", "skills/**/*", "work/**/*", ".cursor/agents/**/*", ".cursor/rules/**/*"]
```
...
- when to read `memory/handbook/index.md`,
- when to read `memory/features/**`,
- when to read `work/**`,
...
- record any deferred migration or architecture changes in `/memory/backlog/index.yaml`.
...
10. `memory/handbook/context-economy.md` exists and is routed from `memory/handbook/index.md`.
