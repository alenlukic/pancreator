...
- `inbox/threads/compliance-tests/68576_0457_round-01.md` -> processed as operator
  clarification input in intake round 2.
- `inbox/threads/compliance-tests/68576_0457_round-02.md` -> resolved with interim
  canonical fallback for gate blocking.
- `inbox/threads/compliance-tests/68576_0457_round-03-approval.md` -> ratified intake
  exit and authorized handoff to `plan`.
- `inbox/in/compliance-tests.md` -> archived to
  `inbox/archive/in/68576_0457_compliance-tests.md` after intake closeout.
...
- `inbox/threads/compliance-tests/68576_0457_round-01.md` (clarifying questions for
  human response).
- `inbox/threads/compliance-tests/68576_0457_round-02.md` (resolved clarification and
  interim canonical fallback decision).
- `inbox/threads/compliance-tests/68576_0457_round-03-approval.md` (human approval for
  intake exit to `plan`).
...
- Approval artifact is `inbox/threads/compliance-tests/68576_0457_round-03-approval.md`.
...
documentation_impact:
  ...
  changed-surfaces:
    ...
    - inbox/threads/compliance-tests/68576_0457_round-01.md
    - inbox/threads/compliance-tests/68576_0457_round-02.md
    - inbox/threads/compliance-tests/68576_0457_round-03-approval.md
    - inbox/out/68576_0457_2026-04-26-intake-processing-report.md
  deferred-items: []
```

## Post-approval rejection processing (round 04)

- `inbox/threads/compliance-tests/68576_0457_round-04-human-reject.md` -> processed as a
...
- Invocation policies MUST cover structure-change scenarios previously
  clarified in `inbox/threads/compliance-tests/68576_0457_round-01.md`.
